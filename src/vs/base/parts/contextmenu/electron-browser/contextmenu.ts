...
/**
 * Show a native context menu via the Tauri backend.
 *
 * We route through the same `vscode:` IPC channels that the preload
 * bridge translates into Tauri `invoke()` calls.
 */
