...
type WebContentsView = any;
type WebContents = any;

const webContents = {
	fromId(id: number): any { return undefined; }
};
...
export class BrowserView extends Disposable implements ICDPTarget {
	...
	constructor(
		...
		createChildView: (options?: any) => BrowserView,
		openContextMenu: (view: BrowserView, params: any) => void,
		...
		// Tauri stub: WebContentsView is an Electron-specific API.
		// In Tauri, webviews are managed through the Tauri webview API.
		this._view = {} as any;
