...
import { ExtensionManagementErrorCode, IAllowedExtensionsService, IExtensionGalleryService, IGalleryExtension, ILocalExtension, InstallOperation, InstallOptions, shouldRequireRepositorySignatureFor } from '../../../../platform/extensionManagement/common/extensionManagement.js';
...
import { buttonBackground, buttonBorder, buttonForeground, buttonHoverBackground, buttonSecondaryBackground, buttonSecondaryForeground, buttonSecondaryHoverBackground, buttonSeparator, contrastBorder, editorErrorForeground, editorInfoForeground, editorWarningForeground, registerColor } from '../../../../platform/theme/common/colorRegistry.js';
